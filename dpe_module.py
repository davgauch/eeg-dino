"""Decoupled Positional Embedding (DPE) — output = E + Pc + Pt.

Pc: learnable spatial embedding averaged over present channels.
Pt: input-dependent temporal embedding via Conv1d on token sequence.
"""
import torch
